...
import com.example.yabz.bayu_1202154127_modul6.DetilFoto;
import com.example.yabz.bayu_1202154127_modul6.Constant;
import com.example.yabz.bayu_1202154127_modul6.CommentModel;
...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.MyViewHolder>{
    ...
    public PhotoAdapter(List<FotoModel> photoList, Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.cvPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(context, DetilFoto.class); //intent menuju detail photo
